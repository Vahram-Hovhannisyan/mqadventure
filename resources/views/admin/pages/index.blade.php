...
@section('title', 'Настройки страниц')
            ...
            <div>
                        ...
                        <div class="pg-row col-2">
                            <div class="pg-field">
                                ...
                                <input type="text" name="site_title"
                                       value="{{ old('site_title', $settings->get('site_title')?->value['value'] ?? '') }}"
                                       placeholder="Meghradzor Quad Adventure" />
                            </div>
                            <div class="pg-field">
                                <label class="pg-label">Email администратора</label>
                                <input type="email" name="admin_email"
                                       value="{{ old('admin_email', $settings->get('admin_email')?->value['value'] ?? '') }}"
                ...
                <div class="pg-section" id="sec-hero">
                    ...
                    <div class="pg-section-body">
                        ...
                        {{-- Hero bg image --}}
                        @include('admin.pages._img_field', [
                            'key'    => 'hero_bg_image',
                            ...
                            <div class="pg-row col-3">
                                @foreach([1, 2, 3] as $n)
                                    <div style="display:flex; flex-direction:column; gap:10px;">
                                        <div class="pg-field">
                                            <label class="pg-label">Цифра {{ $n }}</label>
                                            <input type="text" name="stat{{ $n }}_num"
                                                   value="{{ old("stat{$n}_num", $settings->get("stat{$n}_num")?->value['value'] ?? '') }}"
                                                   placeholder="{{ ['250+','12','6'][$n-1] }}" />
                                        </div>
                                        @include('admin.pages._lang_field', [
                                            'key'     => "stat{$n}_label",
                                            'label'   => "Подпись {$n}",
                    ...
                    <div class="pg-section-body">
                        ...
                        <div class="pg-field">
                            ...
                            <input type="url" name="map_embed_url"
                                   value="{{ old('map_embed_url', $settings->get('map_embed_url')?->value['value'] ?? '') }}"
